    ...
    <div className="p-6 mb-8 bg-gray-800 rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="estimatedTime" className="block text-sm font-medium text-gray-300">Estimated Time (minutes)</label>
            <input
              id="estimatedTime"
              type="number"
              value={estimatedTime}
          ...
          <div>
            <label htmlFor="deadline" className="block text-sm font-medium text-gray-300">Deadline (Optional)</label>
            <input
              id="deadline"
              type="date"
              value={deadline}
